...
```{r musk, echo=FALSE, fig.cap="特斯拉开源Roadster", fig.align='center',out.width = '50%'}
knitr::include_graphics("img/musk.png")
```
...
```{r, echo=FALSE, out.width='120%',cache=TRUE}
knitr::include_graphics('img/threecircle.png')
```
...
```{r, echo=FALSE, out.width='45%',cache=TRUE,fig.align='center'}
knitr::include_graphics('img/最佳工具.png')
```
...
knitr::include_graphics('img/cpu.png')
```
...
```{r, echo=FALSE, out.width='60%',cache=TRUE,fig.align='center'}
knitr::include_graphics('img/gitstatus.png')
```
